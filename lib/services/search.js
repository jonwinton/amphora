...
const elastic = require('elasticsearch'),
  ...
  index = '',
  prefix = process.env.ELASTIC_PREFIX ? process.env.ELASTIC_PREFIX + '-' : index,
  serverConfig = {
    host: endpoint,
    maxSockets: 500,
    apiVersion: '2.4',
...
module.exports.compare = elasticHelpers.compare;
module.exports.convertOpValuesPropertyToDate = elasticHelpers.convertOpValuesPropertyToDate;
module.exports.convertObjectToString = elasticHelpers.convertObjectToString;
module.exports.removeEmptyValuesForProperty = elasticHelpers.removeEmptyValuesForProperty;
